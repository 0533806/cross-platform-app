...
import { StyleSheet, Text, View, Pressable, Dimensions, Image, StatusBar, SafeAreaView } from "react-native";
...
import Mycollect from "./mycollect";
  ...
  const size = 1.3;
  function user ({ navigation, props_Colorful, props_ShowImage }) {
